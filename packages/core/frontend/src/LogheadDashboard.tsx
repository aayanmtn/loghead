...
export function LogheadDashboard() {
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950 text-gray-100">
      {/* Header / Toolbar */}
      <div className="flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 hover:bg-zinc-900 px-3 py-2 rounded-md transition-colors border border-transparent hover:border-zinc-800"
            >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 rounded-md text-sm font-medium transition-colors border border-zinc-700"
          >
