            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Use this token to authenticate your MCP clients or direct API
                  calls.
                </p>
              </div>
            </div>
        ...
        {selectedProject ? (
            ...
            <div className="flex items-center justify-between border-b border-gray-800 pb-4">
              <div>
                <h2 className="text-2xl font-bold text-white">
                  {currentStream ? currentStream.name : "Overview"}
                </h2>
              </div>
            </div>
            ...
            {currentStream ? (
              <div className="space-y-4">
                <div className="text-xs text-gray-500 font-mono bg-gray-900/50 p-2 rounded border border-gray-800 flex gap-4 items-center">
                  <span>
                    Stream ID:{" "}
                    <span className="text-white">{currentStream.id}</span>
                  </span>
                  <span>
                    Logs:{" "}
          ...
          <div className="flex flex-col items-center justify-center h-[50vh] text-gray-500">
            ...
            <p className="text-gray-500 max-w-sm text-center">
              Select a project from the top navigation bar to view its streams
              and logs.
            </p>
          </div>
        )}
